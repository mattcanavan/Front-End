...
export default function HomePage() {
    return (
        <div className="homeContainer">
                <img class="sand" src = 'https://images.unsplash.com/photo-1533227935323-22ca46e5e899?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80'></img>
                <div class="inner">
